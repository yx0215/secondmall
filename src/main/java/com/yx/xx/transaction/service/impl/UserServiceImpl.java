...
import com.yx.xx.transaction.mapper.XxUserMapper;
import com.yx.xx.transaction.service.UserService;
import com.yx.xx.transaction.utils.RegexUtils;
...
//        example.createCriteria().andEqualTo("phone",phone);
    ...
    public ComResult checkXxUser(XxUser xxUser) {
        ...
        if (org.apache.commons.lang3.StringUtils.isBlank(xxUser.getEmail())){
            ...
            comResult = ComResult.fail("手机号码格式不正确"+xxUser.getPhone()+RegexUtils.checkMobile(xxUser.getPhone()));
        }
