package com.yx.xx.transaction.develop.dev.support;
...
import com.yx.xx.transaction.utils.StringUtil;
...
public class XxCodeGenerator {
    ...
    private String packageName = "com.yx.xx.transaction.test";
    ...
    public void run() {
        ...
        pc.setEntity("entity");
        pc.setXml("src/main/webapp/mapper");
