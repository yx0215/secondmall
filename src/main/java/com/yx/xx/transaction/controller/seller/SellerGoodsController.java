package com.yx.xx.transaction.controller.seller;
...
public class SellerGoodsController {
     ...
     * @return
     */
    @ApiOperation(value = "遍历当前卖家的商品信息")
    @GetMapping("page")
    @ResponseBody
    public PageInfo<Goods> pageInfo(HttpServletRequest request, HttpSession session, Goods goods) {
        ...
        PageInfo<Goods> pageInfo = goodsService.page1(draw, start, length, goods,sellerId);
        return pageInfo;
    }
