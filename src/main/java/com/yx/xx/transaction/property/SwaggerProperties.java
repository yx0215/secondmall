package com.yx.xx.transaction.property;
...
public class SwaggerProperties {
    ...
    private List<String> basePackages = new ArrayList(Collections.singletonList("com.yx.xx.transaction"));
    private List<String> basePath = new ArrayList();
    private List<String> excludePath = new ArrayList();
    private String title = "二手 接口文档系统";
    private String description = "二手 接口文档系统";
    private String version = "1.0.0.RELEASE";
    private String license = "Powered By yx";
